  ...
  return (
    <View style={styles.canvas}>
      ...
      <View style={styles.navIsland}>
        ...
        {/* Points */}
        <Text style={styles.pointsLabel} onPress={() => navigation.navigate('Map')}>0</Text>
        ...
        <View style={styles.mapIcon}>
          ...
          <View style={styles.mapIconPart3}>
            <TouchableOpacity style={styles.mapIconPart4} onPress={() => navigation.navigate('Map')}>
              <Image
        ...
        <View style={styles.cameraIcon}>
          <TouchableOpacity style={styles.cameraIconPart1} onPress={() => navigation.navigate('Camera')}>
            <Image
        ...
        <View style={styles.translateIcon}>
          <TouchableOpacity style={styles.translateIconPart1} onPress={() => navigation.navigate('Camera')}>
            <Image
        ...
        <View style={styles.compassIcon}>
          ...
          <TouchableOpacity style={styles.compassIconPart3} onPress={() => navigation.navigate('Compass')}>
          <Image
